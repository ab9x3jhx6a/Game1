...
L1PlayerLayer = cc.Layer.extend({
    ...
    ctor: function () {
        ...
        this.boss = new cc.Sprite(res.bni1_png);
        this.boss.attr({
            x: cc.winSize.width / 2,
...
//////////////////////////////////////////////////////////////////////////////////////
        cc.spriteFrameCache.addSpriteFrame(res.BossNormIdle_plist);
        ...
        var animationBni = new cc.Animation(animFramesBni, 0.50);
        this.animateBni = new cc.Animate(animationBni);
//////////////////////////////////////////////////////////////////////////////////////
        cc.spriteFrameCache.addSpriteFrame(res.BossNormThrow_plist);
        var bntTexture = new cc.textureCache.addImage(res.BossNormThrow_png),
            bntImages = new cc.SpriteBatchNode(bntTexture);
        ...
        var animationBnt = new cc.Animation(animFramesBnt, 0.8);
        this.animateBnt = new cc.Animate(animationBnt);
/////////////////////////////////////////////////////////////////////////////
        cc.spriteFrameCache.addSpriteFrame(res.BossAng1Idle_plist);
        var ba1iTexture = new cc.textureCache.addImage(res.BossAng1Idle_png),
            ba1iImages = new cc.SpriteBatchNode(ba1iTexture);
        ...
        var animationBa1i = new cc.Animation(animFramesBa1i, 0.5);
        this.animateBa1i = new cc.Animate(animationBa1i);
/////////////////////////////////////////////////////////////////////////////////
        cc.spriteFrameCache.addSpriteFrame(res.BossAng1Throw_plist);
        var ba1tTexture = new cc.textureCache.addImage(res.BossAng1Throw_png),
            ba1tImages = new cc.SpriteBatchNode(ba1tTexture);
        ...
        var animationBa1t = new cc.Animation(animFramesBa1t, 0.8);
        this.animateBa1t = new cc.Animate(animationBa1i);
/////////////////////////////////////////////////////////////////////////////////
        cc.spriteFrameCache.addSpriteFrame(res.BossAng2Idle_plist);
        var ba2iTexture = new cc.textureCache.addImage(res.BossAng2Idle_png),
            ba2iImages = new cc.SpriteBatchNode(ba2iTexture);
        ...
        var animationBa2i = new cc.Animation(animFramesBa2i, 0.5);
        this.animateBa2i = new cc.Animate(animationBa2i);
/////////////////////////////////////////////////////////////////////////////////
        cc.spriteFrameCache.addSpriteFrame(res.BossAng2Throw_plist);
        var ba2tTexture = new cc.textureCache.addImage(res.BossAng2Throw_png),
            ba2tImages = new cc.SpriteBatchNode(ba2tTexture);
        ...
        var animationBa2t = new cc.Animation(animFramesBa2t, 0.8);
        this.animateBa2t = new cc.Animate(animationBa2t);
/////////////////////////////////////////////////////////////////////////////////
        cc.spriteFrameCache.addSpriteFrame(res.BossAng3Idle_plist);
        var ba3iTexture = cc.textureCache.addImage(res.BossAng3Idle_png),
            ba3iImages = new cc.SpriteBatchNode(ba3iTexture);
...
/////////////////////////////////////////////////////////////////////////////////
        cc.spriteFrameCache.addSpriteFrame(res.BossAng3Throw_plist);
        var ba3tTexture = new cc.textureCache.addImage(res.BossAng3Throw_png),
            ba3tImages = new cc.SpriteBatchNode(ba3tTexture);
        ...
        var animationBa3t = new cc.Animation(animFramesBa3t, 0.8);
        this.animateBa3t = new cc.Animate(animationBa3t);
/////////////////////////////////////////////////////////////////////////////////
        ...
        var animationLeft = new cc.Animation(animFramesLeft, 0.08);
        var animateLeft = new cc.Animate(animationLeft);
